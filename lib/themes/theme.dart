...
Color tertiaryColor = Colors.white.withAlpha(210);
Color midTertiaryColor = Colors.white.withAlpha(190);
Color lighterTertiaryColor = Colors.white;
Color oppositeTertiaryColor = Colors.black;